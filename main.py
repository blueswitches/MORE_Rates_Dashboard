...
# June 2023
query_51 = "SELECT June_23 FROM residential_rate WHERE Short_Name = 'MORE Power'"
# Execute the query
cursor.execute(query_51)
# Fetch the result
result_51 = cursor.fetchone()

query_52 = "SELECT June_23 FROM residential_rate WHERE Short_Name = 'CENECO'"
# Execute the query
cursor.execute(query_52)
# Fetch the result
result_52 = cursor.fetchone()

query_53 = "SELECT June_23 FROM residential_rate WHERE Short_Name = 'BLCI'"
# Execute the query
cursor.execute(query_53)
# Fetch the result
result_53 = cursor.fetchone()

query_54 = "SELECT June_23 FROM generation_rate WHERE Short_Name = 'MORE Power'"
# Execute the query
cursor.execute(query_54)
# Fetch the result
result_54 = cursor.fetchone()

query_55 = "SELECT June_23 FROM generation_rate WHERE Short_Name = 'CENECO'"
# Execute the query
cursor.execute(query_55)
# Fetch the result
result_55 = cursor.fetchone()

query_56 = "SELECT June_23 FROM generation_rate WHERE Short_Name = 'BLCI'"
# Execute the query
...
query_57 = """
SELECT Short_Name, June_23
FROM residential_rate
WHERE June_23_Ranking BETWEEN 1 AND 5
ORDER BY June_23_Ranking ASC;
"""
...
SELECT Short_Name, June_23
FROM residential_rate
WHERE June_23_Ranking_Vis BETWEEN 1 AND 5
ORDER BY June_23_Ranking_Vis ASC;
"""
...
# July 2023
query_61 = "SELECT July_23 FROM residential_rate WHERE Short_Name = 'MORE Power'"
# Execute the query
cursor.execute(query_61)
# Fetch the result
result_61 = cursor.fetchone()

query_62 = "SELECT July_23 FROM residential_rate WHERE Short_Name = 'CENECO'"
# Execute the query
cursor.execute(query_62)
# Fetch the result
result_62 = cursor.fetchone()

query_63 = "SELECT July_23 FROM residential_rate WHERE Short_Name = 'BLCI'"
# Execute the query
cursor.execute(query_63)
# Fetch the result
result_63 = cursor.fetchone()

query_64 = "SELECT July_23 FROM generation_rate WHERE Short_Name = 'MORE Power'"
# Execute the query
cursor.execute(query_64)
# Fetch the result
result_64 = cursor.fetchone()

query_65 = "SELECT July_23 FROM generation_rate WHERE Short_Name = 'CENECO'"
# Execute the query
cursor.execute(query_65)
# Fetch the result
result_65 = cursor.fetchone()

query_66 = "SELECT July_23 FROM generation_rate WHERE Short_Name = 'BLCI'"
# Execute the query
...
query_67 = """
SELECT Short_Name, July_23
FROM residential_rate
WHERE July_23_Ranking BETWEEN 1 AND 5
ORDER BY July_23_Ranking ASC;
"""
...
SELECT Short_Name, July_23
FROM residential_rate
WHERE July_23_Ranking_Vis BETWEEN 1 AND 5
ORDER BY July_23_Ranking_Vis ASC;
"""
...
if month_selected == 'January 2023':
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_49] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_50] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_59] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_60] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_69] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_70] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_79] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_80] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_89] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_90] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_99] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_100] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_109] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_110] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_119] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_120] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_129] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_130] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_139] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_140] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_149] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_150] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_159] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_160] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_169] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_170] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_179] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_180] # Extract Residential Rate
        }
    ...
    with col3:
        ...
        table_4 = {
            ...
            "Residential Rate": [row[1] for row in result_189] # Extract Residential Rate
        }
    ...
    with col4:
        ...
        table_5 = {
            ...
            "Residential Rate": [row[1] for row in result_190] # Extract Residential Rate
        }
